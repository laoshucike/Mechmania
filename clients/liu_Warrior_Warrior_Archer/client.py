...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Warrior_Warrior_Archer' ,
            'Characters': [{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Archer","ClassId": "Archer"}] }
# ---------------------------------------------------------------------
