...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Archer_Archer_Archer',
            'Characters': [{"CharacterName": "Archer}","ClassId": "Archer"},{"CharacterName": "Archer}","ClassId": "Archer"},{"CharacterName": "Archer}","ClassId": "Archer"}]}
# ---------------------------------------------------------------------
