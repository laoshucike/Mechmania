...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Druid_Druid_Assassin',
            'Characters': [{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Assassin}","ClassId": "Assassin"}]}
# ---------------------------------------------------------------------
