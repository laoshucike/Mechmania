...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Wizard_Wizard_Wizard',
            'Characters': [{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Wizard}","ClassId": "Wizard"}]}
# ---------------------------------------------------------------------
