...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Wizard_Sorcerer_Druid' ,
            'Characters': [{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Sorcerer}","ClassId": "Sorcerer"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
