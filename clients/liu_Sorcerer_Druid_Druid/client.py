...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Sorcerer_Druid_Druid' ,
            'Characters': [{"CharacterName": "Sorcerer}","ClassId": "Sorcerer"},{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
