...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Wizard_Druid_Archer' ,
            'Characters': [{"CharacterName": "Wizard","ClassId": "Wizard"},{"CharacterName": "Druid","ClassId": "Druid"},{"CharacterName": "Archer","ClassId": "Archer"}] }
# ---------------------------------------------------------------------
