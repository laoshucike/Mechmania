...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Paladin_Druid_Druid' ,
            'Characters': [{"CharacterName": "Paladin}","ClassId": "Paladin"},{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
