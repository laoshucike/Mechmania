...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Sorcerer_Druid_Archer' ,
            'Characters': [{"CharacterName": "Sorcerer","ClassId": "Sorcerer"},{"CharacterName": "Druid","ClassId": "Druid"},{"CharacterName": "Archer","ClassId": "Archer"}] }
# ---------------------------------------------------------------------
