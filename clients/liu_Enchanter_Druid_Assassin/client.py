...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Enchanter_Druid_Assassin' ,
            'Characters': [{"CharacterName": "Enchanter}","ClassId": "Enchanter"},{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Assassin}","ClassId": "Assassin"}]}
# ---------------------------------------------------------------------
