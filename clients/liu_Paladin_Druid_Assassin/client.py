...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Paladin_Druid_Assassin' ,
            'Characters': [{"CharacterName": "Paladin}","ClassId": "Paladin"},{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Assassin}","ClassId": "Assassin"}]}
# ---------------------------------------------------------------------
