...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Wizard_Warrior_Warrior' ,
            'Characters': [{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Warrior}","ClassId": "Warrior"},{"CharacterName": "Warrior}","ClassId": "Warrior"}]}
# ---------------------------------------------------------------------
