...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Paladin_Paladin_Druid' ,
            'Characters': [{"CharacterName": "Paladin}","ClassId": "Paladin"},{"CharacterName": "Paladin}","ClassId": "Paladin"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
