...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Enchanter_Enchanter_Druid' ,
            'Characters': [{"CharacterName": "Enchanter}","ClassId": "Enchanter"},{"CharacterName": "Enchanter}","ClassId": "Enchanter"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
