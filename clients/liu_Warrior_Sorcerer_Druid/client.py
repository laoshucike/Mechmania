...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Warrior_Sorcerer_Druid' ,
            'Characters': [{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Sorcerer","ClassId": "Sorcerer"},{"CharacterName": "Druid","ClassId": "Druid"}] }
# ---------------------------------------------------------------------
