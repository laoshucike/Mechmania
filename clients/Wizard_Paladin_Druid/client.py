...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Wizard_Paladin_Druid',
            'Characters': [{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Paladin}","ClassId": "Paladin"},{"CharacterName": "Druid}","ClassId": "Druid"}]}
# ---------------------------------------------------------------------
