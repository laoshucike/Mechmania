...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Warrior_Assassin_Assassin' ,
            'Characters': [{"CharacterName": "Warrior}","ClassId": "Warrior"},{"CharacterName": "Assassin}","ClassId": "Assassin"},{"CharacterName": "Assassin}","ClassId": "Assassin"}]}
# ---------------------------------------------------------------------
