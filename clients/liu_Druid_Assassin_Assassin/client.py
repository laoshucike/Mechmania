...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Druid_Assassin_Assassin' ,
            'Characters': [{"CharacterName": "Druid}","ClassId": "Druid"},{"CharacterName": "Assassin}","ClassId": "Assassin"},{"CharacterName": "Assassin}","ClassId": "Assassin"}]}
# ---------------------------------------------------------------------
