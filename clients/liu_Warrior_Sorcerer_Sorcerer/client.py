...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Warrior_Sorcerer_Sorcerer' ,
            'Characters': [{"CharacterName": "Warrior}","ClassId": "Warrior"},{"CharacterName": "Sorcerer}","ClassId": "Sorcerer"},{"CharacterName": "Sorcerer}","ClassId": "Sorcerer"}]}
# ---------------------------------------------------------------------
