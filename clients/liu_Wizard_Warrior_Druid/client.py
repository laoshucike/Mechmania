...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Wizard_Warrior_Druid' ,
            'Characters': [{"CharacterName": "Wizard","ClassId": "Wizard"},{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Druid","ClassId": "Druid"}] }
# ---------------------------------------------------------------------
