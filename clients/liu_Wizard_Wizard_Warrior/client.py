...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName': 'Wizard_Wizard_Warrior' ,
            'Characters': [{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Wizard}","ClassId": "Wizard"},{"CharacterName": "Warrior}","ClassId": "Warrior"}]}
# ---------------------------------------------------------------------
