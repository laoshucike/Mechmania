...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Enchanter_Druid_Archer' ,
            'Characters': [{"CharacterName": "Enchanter","ClassId": "Enchanter"},{"CharacterName": "Druid","ClassId": "Druid"},{"CharacterName": "Archer","ClassId": "Archer"}] }
# ---------------------------------------------------------------------
