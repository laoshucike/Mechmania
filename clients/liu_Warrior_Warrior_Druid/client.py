...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Warrior_Warrior_Druid' ,
            'Characters': [{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Warrior","ClassId": "Warrior"},{"CharacterName": "Druid","ClassId": "Druid"}] }
# ---------------------------------------------------------------------
