...
def initialResponse():
# ------------------------- CHANGE THESE VALUES -----------------------
    return {'TeamName':'liu_Druid_Assassin_Archer' ,
            'Characters': [{"CharacterName": "Druid","ClassId": "Druid"},{"CharacterName": "Assassin","ClassId": "Assassin"},{"CharacterName": "Archer","ClassId": "Archer"}] }
# ---------------------------------------------------------------------
